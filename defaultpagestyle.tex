\RequirePackage[autocite = superscript, backend = bibtex, style = \documentBibliographyStyle]{biblatex}
...
% CUSTOM COMMANDS ===================================
\input{lib/customcommands}
\input{lib/customenvironments}
...
\setkomafont{pagehead}		  {\headerStyle}
\setkomafont{pagefoot}		  {\footerStyle}
\setkomafont{pagenumber}		{\pagemarkStyle}
